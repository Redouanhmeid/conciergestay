...
module.exports = (db, type) => {
  ...
  propertymanager.ValidateCreate = async function(email, password, firstname, lastname, phone ) {
    ...
    const PropertyManager = await propertymanager.create({ email, password : hash, firstname, lastname, phone })
