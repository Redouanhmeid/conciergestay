     ...
     <div className="container-fluid">
      <Form layout="vertical" size="large">
       <Row gutter={[24, 0]}>
        ...
        <Col xs={24} md={12}>
         <Form.Item label="Qualification, Profession, المهنة" name="Profession">
          <Input />
         </Form.Item>
        </Col>
        <Col xs={24} md={12}>
        ...
        <Col xs={24} md={12}>
         <Form.Item label="N° Téléphone, Phone, رقم الهاتف" name="phone">
        ...
        <Col xs={24} md={24}>
         <Text>
          Signature électronique, Electronic signature, إمضاء إلكتروني
         </Text>
         <Form.Item
          name="electronicsign"
          style={{
        ...
        <Col xs={24} md={24}>
         <Form.Item label="Identité, Identity , الهوية" name="Identity">
          <Upload
